...
const mobileweb = () => {
    ...
    return (
        ...
        <Layout>
            <PageBanner pageName={"Mobile Web Design"} img={"https://searchengineland.com/wp-content/seloads/2018/04/responsive-design-ss-1-800x450.jpg"} />
                ...
                <div className="container">
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                ...
                                <div className="image mb-35">
                                    <img
                                        src="https://searchengineland.com/wp-content/seloads/2018/04/responsive-design.gif"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="mt-40">Our Mobile Web Design Services</h3>
                            <ul className="list-style-two mb-45">
