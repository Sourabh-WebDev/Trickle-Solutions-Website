...
const webportaldevelopment = () => {
    ...
    const tasks = [
        ...
        'User-friendly & easy to navigate portal interface',
    ...
    return (
        ...
        <Layout>
            <PageBanner pageName={"Web Portal Development"} img={"https://eluminoustechnologies.com/blog/wp-content/uploads/2022/07/MicrosoftTeams-image-22.png"} />
                ...
                <div className="container">
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                <div className="course-header">
                                    <span className="category">Web Portal Development</span>
                            ...
                            <li>
                                ...
                                <div className="image mb-35">
                                    <img
                                        src="https://eluminoustechnologies.com/blog/wp-content/uploads/2022/07/05-4.png"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>
                                    A web portal needs to have the right mix of technical functionality, aesthetic excellence, and interactive elements to stand out in terms of appearance,
                                    functionality, and structure. WeblinkIndia excels in the field of
                                    to ensure your portal reflects your business idea. Covering diverse fields like real estate tour & travel, placement industry, e-commerce etc., we make e-cooperation among partners, customers, and clients seamless with our feature-rich web portals.
                                </p>
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="mt-40">Why You Need A Web Portal</h3>
                            <ul className="list-style-two mb-45">
                                ...
                                <li>
                                    Projects Completed Within The Specified Deadlines
                                </li>
                                <li>
                                    Incorporation Of Relevant Keywords Resulting In Higher Page Rankings
                                </li>
                            </ul>
