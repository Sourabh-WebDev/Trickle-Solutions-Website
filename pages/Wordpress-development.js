                        ...
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                ...
                                <div className="image mb-35">
                                    <img
                                        src="https://www.freelancetoindia.com/wp-content/uploads/2019/01/WordPress-Development.jpg"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>
                                    WordPress website is one that has web pages stored on the server in the format that is sent to a client web browser.
