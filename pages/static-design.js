...
const staticdesign = () => {
    ...
    const tasks = [
        ...
        'Promotion At All Search Engines Like Google, Bing, Etc. ',
    ...
    return (
        ...
        <Layout>
            <PageBanner pageName={"Static Web Design"} img={"https://www.wsneconsulting.com/img/new_img_page/responsive-static-website.jpg"} />
                ...
                <div className="container">
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                ...
                                <div className="image mb-35">
                                    <img
                                        src="https://www.wsneconsulting.com/img/new_img_page/responsive-static-website.jpg"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="mt-40"> Features of Our Static Web Design</h3>
                            <ul className="list-style-two mb-45">
