...
const graphicdesigning = () => {
  ...
  const tasks = [
      'Multimedia solutions are the most effectual means of conveying the ideas.',
      'Multimedia solutions make the presentation way more convenient and attention-grabbing.',
      'Suggestion for Landing Page Optimization',
      'Multimedia solutions make the visual presentation more attractive and eye-catching.',
      ...
      'Multimedia solutions add value to a brand.',
      'Multimedia solutions create a lasting impact on the visitor'
              ...
              <div className="container">
                  <div className="row large-gap">
                      <div className="col-lg-6">
                          <div className="course-details-content">
                              <div className="course-header">
                                  <span className="category">Graphic Designing</span>
                              ...
                              <h3>Uses Of Multimedia Graphic Designs</h3>
                              ...
                              <div className="image mb-35">
                                  <img
                                      src="https://www.etudemy.com/wp-content/uploads/2021/09/Graphic-Designing-Courses-in-perinthalmannamalappuram.jpg"
                                      alt="Course Details"
                                  />
                              </div>
                      ...
                      <div className="col-lg-6">
                          ...
                          <h3 className="mt-40">Our Multimedia Graphic Design Solutions:-</h3>
                          <ul className="list-style-two mb-45">
