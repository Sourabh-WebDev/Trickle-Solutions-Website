                ...
                <div className="container">
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            <div className="course-details-content">
                                <div className="course-header">
                                    <span className="category">Affiliate Marketing</span>
                                ...
                                <div className="image mb-35">
                                    <img
                                        src="https://thumbs.dreamstime.com/z/marketing-branding-planning-vision-goals-concept-84041481.jpg?w=768"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="mt-40">Affiliate  Marketing Points</h3>
                            <ul className="list-style-two mb-45">
