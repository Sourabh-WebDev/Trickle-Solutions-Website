...
const windowserver = () => {
    ...
    return (
        <Layout>
            <PageBanner pageName={"Window Dedicated Server"} img={"https://www.cloudoye.com/images/blog/Windows-Dedicated.jpg"} />
                ...
                <div className="container">
                    <div className="row large-gap">
                        <div className="col-lg-6">
                            ...
                            <li>
                                ...
                                <div className="image mb-35">
                                    <img
                                        src="https://qph.cf2.quoracdn.net/main-qimg-947f8d20408132deb9126d71e3b92043.webp"
                                        alt="Course Details"
                                    />
                                </div>
                                <p>

                                    Businesses with larger websites and apps trust dedicated servers more than taking hosting services as it offers them the security, flexibility
                                    and power to customize everything as per their requirements. Windows dedicated servers are dedicated hardware with power-packed performance to make your website outperform on the parameters of usability,
                                    speed, and functionality. WeblinkIndia, a trusted windows dedicated hosting provider, empowers you with customizable Windows dedicated server hosting. With our servers, you can choose the operating system you require,
                                    access the administrative panel, and get full control of the servers.
                                </p>
                        ...
                        <div className="col-lg-6">
                            ...
                            <h3 className="mt-40">Features of Our Window Dedicated Server</h3>
                            <ul className="list-style-two mb-45">
